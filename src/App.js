      ...
      {location.pathname.startsWith("/admin") ? (
        ...
        <NoHeaderLayout>
          <Routes>
            ...
            <Route path="/tai-khoan/ho-so" element={<ProfileUser />} />
            <Route path="/tai-khoan/nap-tien" element={<NapTien />} />
            <Route path="/tai-khoan/tu-truyen" element={<BookCase />} />
            <Route path="/account" element={<Account />} />
            <Route path="/dang-truyen/them-truyen" element={<AddStoryUser />} />
            <Route
              path="/dang-truyen/danh-sach-truyen"
              element={<ListStoryUser />}
            />
            <Route
              path="/dang-truyen/sua-truyen/:id"
              element={<EditStoryUser />}
            />
            <Route
              path="/dang-truyen/sua-truyen/danh-sach-chuong/:id"
              element={<ListChapterUser />}
            />
            <Route
              path="/dang-truyen/them-chuong/:id"
              element={<AddChapterUser />}
            />
            <Route
              path="/dang-truyen/sua-truyen/truyen/:storyId/chuong/:chapterId"
              element={<ChapterDeatailUser />}
            />
          </Routes>
        </NoHeaderLayout>
      )}
